...
class SingleHouseModel(ABC):
    ...
    def calculate_loan_to_value(self) -> float:
        ...
        """
        return round(loan_to_value(loan_amount=self.mortgage.total_initial_loan_amount,
                                   after_repair_value=self.real_estate_property.after_repair_value), 2)
    ...
    def calculate_annual_irr(self) -> float:
        ...
        if len(annual_cash_flow_distribution) == 1 and annual_cash_flow_distribution[0] == 0:
            return 0
    ...
    def calculate_annual_cash_flow_distribution(self) -> List[int]:
        ...
        annual_cash_flow_distribution = [
            ...
            for a, b in zip(annual_revenue_distribution, annual_expenses_distribution)
        ]
    ...
    def calculate_total_renovation_expenses(self) -> int:
        ...
        if isinstance(self.renovation_expenses, dict):
            return sum(value if value is not None else 0 for value in self.renovation_expenses.values())
        return self.renovation_expenses if self.renovation_expenses is not None else 0
    ...
    def calculate_purchase_additional_transactions_cost(self) -> int:
        ...
        if isinstance(self.additional_transaction_costs_dic, dict):
            return sum(value if value is not None else 0 for value in self.additional_transaction_costs_dic.values())
    ...
    def calculate_monthly_property_management_fees(self, management_fees_percentage: Optional[float] = None) -> int:
        ...
        :param management_fees_percentage: Optional. Custom management fees percentage. If not provided, uses the properties value.
    ...
    def calculate_monthly_vacancy_cost(self, vacancy_percentage: Optional[float] = None) -> int:
        ...
        :param vacancy_percentage: Optional. Custom vacancy percentage. If not provided, uses the properties value.
    ...
    # Selling
    def calculate_annual_estimated_property_value(self, years: Optional[int] = None,
                                                  annual_appreciation_percentage: Optional[int] = None) -> List[int]:
        """
        Calculate the annual estimated property value over a specified number of years.

        :param years: Optional. Number of years for estimation. If not provided, uses the properties value.
        :param annual_appreciation_percentage: Optional. Custom annual appreciation percentage. If not provided, uses the properties value.
    ...
    def calculate_estimated_property_value(self, years: Optional[int] = None,
                                           annual_appreciation_percentage: Optional[int] = None) -> int:
        """
        ...
        if annual_appreciation_percentage is None:
            annual_appreciation_percentage = self.real_estate_property.annual_appreciation_percentage
        return round(
            self.real_estate_property.after_repair_value * np.power((1 + annual_appreciation_percentage / 100), years))
    ...
    def estimate_sale_price(self, annual_appreciation_percentage: Optional[int] = None) -> int:
        ...
        if annual_appreciation_percentage is None:
            annual_appreciation_percentage = self.real_estate_property.annual_appreciation_percentage
        return round(
            self.calculate_estimated_property_value(annual_appreciation_percentage=annual_appreciation_percentage))
    ...
    def plot_estimated_property_value(self, year_to_exit: Optional[int] = None,
    ...
    def plot_property_equity_vs_years(self, year_to_exit: Optional[int] = None,
                                      annual_appreciation_percentage: Optional[int] = None):
        if year_to_exit is None:
            year_to_exit = self.years_to_exit
        if annual_appreciation_percentage is None:
