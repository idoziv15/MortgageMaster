...
from .real_estate_investor import RealEstateInvestor
from ..mortgage.mortgage_utils.mortgage_financial_utils_il import calculate_maximum_loan_amount
from .real_estate_investment_type import RealEstateInvestmentType
...
class RealEstateInvestorsPortfolio:
    ...
    def calculate_maximum_loan_amount(self, monthly_payment: Optional[int] = None, num_payments: int = 360) -> int:
        ...
        :param num_payments: The total number of loan payments (properties is 360).
