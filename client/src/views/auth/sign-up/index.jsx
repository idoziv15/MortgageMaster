...
export default function SignUp() {
    ...
    const handleSignUp = async () => {
        ...
        if (!validateName(firstName)) {
            setError("First name must be between 2 and 20 characters long and contain only letters.");
            return;
        }

        if (!validateName(lastName)) {
            setError("Last name must be between 2 and 20 characters long and contain only letters.");
            return;
        }
